...
namespace AiDoc.Core.ApiClient;

public class DocumentationApiClient : IDocumentationApiClient
{
    private readonly HttpClient _httpClient;

    public DocumentationApiClient(string? apiUrl = null)
    {
        _httpClient = new HttpClient
        {
            BaseAddress = new Uri(apiUrl ?? Environment.GetEnvironmentVariable("API_URL") ?? "http://localhost:8000")
        };
    }
